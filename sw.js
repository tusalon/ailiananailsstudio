...
const CACHE_NAME = 'ailiananailsstudio-v25';
const urlsToCache = [
  '/ailiananailsstudio/',
  '/ailiananailsstudio/index.html',
  '/ailiananailsstudio/admin.html',
  '/ailiananailsstudio/admin-login.html',
  '/ailiananailsstudio/calendar.html',
  '/ailiananailsstudio/setup-wizard.html',
  '/ailiananailsstudio/editar-negocio.html',
  '/ailiananailsstudio/manifest.json',
  '/ailiananailsstudio/icons/icon-72x72.png',
  '/ailiananailsstudio/icons/icon-96x96.png',
  '/ailiananailsstudio/icons/icon-128x128.png',
  '/ailiananailsstudio/icons/icon-144x144.png',
      ...
      .catch(() => {
        ...
        return caches.match(event.request).then(cachedResponse => {
          ...
          if (event.request.url.match(/\.(jpg|jpeg|png|gif|svg|webp)$/)) {
            return caches.match('/ailiananailsstudio/icons/icon-192x192.png');
          }
